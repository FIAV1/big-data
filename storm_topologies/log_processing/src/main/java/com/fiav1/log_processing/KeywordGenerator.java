...
public class KeywordGenerator {
	...
	public static void main(String[] abc) {
		System.out.println(new KeywordGenerator().getKeyword(
				"https://in.search.yahoo.com/search;_ylt=AqH0NZe1hgPCzVap0PdKk7GuitIF?p=india+live+score&toggle=1&cop=mss&ei=UTF-8&fr=yfp-t-704"));
	}
